...
const SECTION_CONFIGS: Record<Mood, Record<Section, SectionConfig>> = {
  ambient: {
    ...
    peak:      { activeLayers: ALL_LAYERS, densityTarget: 0.6, brightnessTarget: 0.65, spaciousnessTarget: 0.75, duration: [50, 100] },
    breakdown: { activeLayers: ['drone', 'harmony', 'atmosphere'], densityTarget: 0.3, brightnessTarget: 0.30, spaciousnessTarget: 0.9, duration: [40, 70] },
    groove:    { activeLayers: ['drone', 'harmony', 'melody', 'arp', 'atmosphere'], densityTarget: 0.5, brightnessTarget: 0.50, spaciousnessTarget: 0.8, duration: [50, 90] },
  },
  downtempo: {
    intro:     { activeLayers: ['drone', 'atmosphere'], densityTarget: 0.3, brightnessTarget: 0.30, spaciousnessTarget: 0.8, duration: [16, 30] },
  ...
  lofi: {
    intro:     { activeLayers: ['drone', 'atmosphere'], densityTarget: 0.3, brightnessTarget: 0.25, spaciousnessTarget: 0.7, duration: [12, 24] },
    build:     { activeLayers: ['drone', 'harmony', 'texture', 'atmosphere'], densityTarget: 0.5, brightnessTarget: 0.40, spaciousnessTarget: 0.55, duration: [20, 40] },
    peak:      { activeLayers: ALL_LAYERS, densityTarget: 0.7, brightnessTarget: 0.60, spaciousnessTarget: 0.6, duration: [30, 55] },
    breakdown: { activeLayers: ['drone', 'harmony', 'arp', 'atmosphere'], densityTarget: 0.35, brightnessTarget: 0.30, spaciousnessTarget: 0.75, duration: [16, 30] },
    groove:    { activeLayers: ALL_LAYERS, densityTarget: 0.65, brightnessTarget: 0.50, spaciousnessTarget: 0.65, duration: [25, 50] },
  },
  trance: {
    intro:     { activeLayers: ['drone', 'atmosphere'], densityTarget: 0.3, brightnessTarget: 0.30, spaciousnessTarget: 0.7, duration: [10, 20] },
    ...
    breakdown: { activeLayers: ['drone', 'harmony', 'melody', 'atmosphere'], densityTarget: 0.35, brightnessTarget: 0.35, spaciousnessTarget: 0.8, duration: [12, 24] },
  ...
  avril: {
    ...
    breakdown: { activeLayers: ['drone', 'harmony', 'atmosphere'], densityTarget: 0.25, brightnessTarget: 0.25, spaciousnessTarget: 0.9, duration: [35, 60] },
  ...
  xtal: {
    ...
    breakdown: { activeLayers: ['drone', 'harmony', 'atmosphere'], densityTarget: 0.25, brightnessTarget: 0.25, spaciousnessTarget: 0.95, duration: [40, 70] },
  ...
  blockhead: {
    ...
    breakdown: { activeLayers: ['drone', 'harmony', 'melody', 'atmosphere'], densityTarget: 0.35, brightnessTarget: 0.35, spaciousnessTarget: 0.75, duration: [20, 40] },
  ...
  flim: {
    ...
    breakdown: { activeLayers: ['drone', 'harmony', 'atmosphere'], densityTarget: 0.25, brightnessTarget: 0.25, spaciousnessTarget: 0.9, duration: [30, 50] },
